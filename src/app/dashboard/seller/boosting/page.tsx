      ...
      <div className="py-8 px-6 sm:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{mockActiveBoosts.length}</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{boostedListings}</p>
                  <p className="text-sm text-gray-500">Boosted Listings</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{unboostedListings}</p>
                  <p className="text-sm text-gray-500">Unboosted Listings</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="bg-gray-50 px-8 py-6 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Choose Your Boost Plan</h2>
                <p className="text-gray-600">Select the perfect plan based on duration and number of listings</p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-center mb-6">
                          ...
                          <p className="text-sm text-gray-600 mt-1">Up to {plan.maxListings} listings</p>
                        </div>
                        ...
                        <Button 
                          className="w-full py-3 font-semibold cursor-pointer bg-teal-600 hover:bg-teal-700 text-white transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
          ...
          <div className="mb-12">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="bg-gray-50 px-8 py-6 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Your Active Boosts</h2>
                <p className="text-gray-600">Monitor your currently boosted listings and their remaining time</p>
              </div>
              ...
              <div className="p-8">
                ...
                {mockActiveBoosts.length === 0 ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-gray-500 mb-6">Start boosting your listings to increase visibility and bookings</p>
                    <Button 
                  ...
                  <div className="space-y-6">
                    {mockActiveBoosts.map((boost) => {
                      ...
                      return (
                        <div
                          key={boost.id}
                          className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-teal-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                        >
                          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                <h3 className="text-lg font-semibold text-gray-900">{boost.listingTitle}</h3>
                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(boost.status)}`}>
                                  {boost.status.replace('_', ' ').toUpperCase()}
                                </span>
                              </div>
                              <p className="text-gray-600 mb-3">{boost.plan}</p>
