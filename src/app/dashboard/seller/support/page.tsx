    ...
    <div className="p-6 md:p-8 bg-gray-50 min-h-screen font-sans">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow flex flex-col">
          ...
          <button
            className="self-end text-gray-500 hover:text-blue-600 transition-colors"
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="text-sm space-y-2">
            <div className="flex items-center gap-2">
              ...
              <a href="tel:123-456-789" className="text-blue-600 hover:underline ml-1">123 - 456 - 789</a>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="w-4 h-4 text-blue-600" />
              <span className="text-gray-700">Email us at:</span>
              <a href="mailto:support@evintli.com" className="text-blue-600 hover:underline ml-1">support@evintli.com</a>
            </div>
          </div>
        </div>
        ...
        {/* Feedback Card */}
        <div className="bg-white p-6 rounded-lg shadow lg:col-start-3">
          ...
          <div className="text-sm flex items-center gap-2">
            <Mail className="w-4 h-4 text-blue-600" />
            <span className="text-gray-700">Email us at:</span>
            <a href="mailto:feedback@evintli.com" className="text-blue-600 hover:underline ml-1">feedback@evintli.com</a>
          </div>
        </div>
      </div>
    </div>
