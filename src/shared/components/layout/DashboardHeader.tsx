...
export default function DashboardHeader({ userType, title = 'Dashboard', subtitle }: Props) {
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='relative' ref={dropdownRef}>
          ...
          >
            ...
            <div className='cursor-pointer relative'>
              {getAvatarUrl() ? (
                <Image
                  ...
                  alt={getDisplayName()}
                  className={cn(
                    'w-10 h-10 rounded-full object-cover border-2 border-gray-200',
                    'group-hover:border-teal-700 transition-colors duration-200'
                  )}
                  width={40}
                  height={40}
                />
                ...
                <div
                  className={cn(
                    'w-10 h-10 rounded-full bg-teal-600 flex items-center justify-center border-2',
                    'border-gray-200 group-hover:border-teal-700 transition-colors duration-200'
                  )}
                >
            ...
            <ChevronDown
              className={cn(
                'cursor-pointer w-4 h-4 text-gray-500 group-hover:text-teal-700 transition-all',
                `duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`
              )}
            />
          </button>
          ...
          {isDropdownOpen && (
            <div className={cn(
              'absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border',
              'border-gray-200 py-2 z-50 transform transition-all duration-200 ease-out'
            )}>
