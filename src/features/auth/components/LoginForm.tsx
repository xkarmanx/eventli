  ...
  return (
      <Card className="w-full max-w-md bg-white shadow-md rounded-lg border">
        <CardHeader className="text-center p-4">
            ...
            <CardTitle className="text-xl font-bold text-gray-900 pt-3">Welcome back</CardTitle>
            <CardDescription className="pt-1 text-sm text-gray-600">Sign in to continue to Eventli.</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-teal-600 hover:text-teal-700 transition">
                  Forgot password?
                </Link>
              </div>
